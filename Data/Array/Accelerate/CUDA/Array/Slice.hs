...
import Data.Array.Accelerate.Array.Sugar                ( Shape, Z(..), (:.)(..) )
...
data Permut where
  Permut :: Shape sh
         ...
         -> (Exp sh -> Exp sh) -- backward permutation
         -> Permut

instance Show Permut where
  show (Permut sh _ _) = show sh

-- TODO, make shape polymorphic.
...
slicePermut ((ac0, ac), r, (afs, as, fas)) =
  ...
  case ac of
    [] ->
      Permut
        (sh:.ac0)
        (lift1 $ \(Z:.as:.r:.ac) -> Z:.r:.as:.ac :: Z:.Exp Int:.Exp Int:.Exp Int)
        (lift1 $ \(Z:.r:.as:.ac) -> Z:.as:.r:.ac :: Z:.Exp Int:.Exp Int:.Exp Int)
    [(f0,a0)] ->
      Permut
        (sh:.a0:.f0:.ac0)
        (lift1 $ \(Z:.as:.r:.a0:.f0:.ac) -> Z:.r:.f0:.as:.a0:.ac :: Z:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int)
        (lift1 $ \(Z:.r:.f0:.as:.a0:.ac) -> Z:.as:.r:.a0:.f0:.ac :: Z:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int)
    [(f0,a0),(f1,a1)] ->
      Permut
        (sh:.a1:.f1:.a0:.f0:.ac0)
        (lift1 $ \(Z:.as:.r:.a1:.f1:.a0:.f0:.ac) ->
          Z:.r:.f1:.f0:.as:.a1:.a0:.ac :: Z:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int)
        (lift1 $ \(Z:.r:.f1:.f0:.as:.a1:.a0:.ac) ->
          Z:.as:.r:.a1:.f1:.a0:.f0:.ac :: Z:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int)
    [(f0,a0),(f1,a1),(f2,a2)] ->
      Permut
        (sh:.a2:.f2:.a1:.f1:.a0:.f0:.ac0)
        (lift1 $ \(Z:.as:.r:.a2:.f2:.a1:.f1:.a0:.f0:.ac) ->
          Z:.r:.f2:.f1:.f0:.as:.a2:.a1:.a0:.ac :: Z:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int)
        (lift1 $ \(Z:.r:.f2:.f1:.f0:.as:.a2:.a1:.a0:.ac) ->
          Z:.as:.r:.a2:.f2:.a1:.f1:.a0:.f0:.ac :: Z:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int)
    [(f0,a0),(f1,a1),(f2,a2),(f3,a3)] ->
      Permut
        (sh:.a3:.f3:.a2:.f2:.a1:.f1:.a0:.f0:.ac0)
        (lift1 $ \(Z:.as:.r:.a3:.f3:.a2:.f2:.a1:.f1:.a0:.f0:.ac) ->
          Z:.r:.f3:.f2:.f1:.f0:.as:.a3:.a2:.a1:.a0:.ac :: Z:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int)
        (lift1 $ \(Z:.r:.f3:.f2:.f1:.f0:.as:.a3:.a2:.a1:.a0:.ac) ->
          Z:.as:.r:.a3:.f3:.a2:.f2:.a1:.f1:.a0:.f0:.ac :: Z:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int:.Exp Int)
